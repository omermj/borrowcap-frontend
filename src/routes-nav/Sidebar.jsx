  ...
  const borrowerSidebar = () => {
    return (
      <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start">
        ...
        <li>
          <Link to="/borrower/wallet" className="nav-link px-0 align-middle">
  ...
  const investorSidebar = () => {
    return (
      <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start">
        ...
        <li>
          <Link to="/investor/pledges" className="nav-link px-0 align-middle">
        ...
        <li>
          <Link to="/investor/wallet" className="nav-link px-0 align-middle">
            <i className="fs-5 bi-wallet-fill"></i>{" "}
            <span className="ms-1 d-none d-sm-inline">Wallet</span>
          </Link>
        </li>
